...
func TestRunRuntimeProfileList(t *testing.T) {
	...
	t.Setenv("DIDIAN_WORKSPACE_ID", "ws-123")
...
func TestRunRuntimeProfileSetPathPreservesExistingConfig(t *testing.T) {
	...
	seed := cli.CLIConfig{ServerURL: "https://api.didian.ai", WorkspaceID: "ws-123", Token: "mul_xyz"}
	...
	if cfg.ServerURL != "https://api.didian.ai" || cfg.WorkspaceID != "ws-123" || cfg.Token != "mul_xyz" {
