...
import type { Issue, IssueStatus, IssuePriority, IssueAssigneeType, Attachment } from "@didian/core/types";
...
import { Tooltip, TooltipTrigger, TooltipContent, TooltipProvider } from "@didian/ui/components/ui/tooltip";
...
import { useCurrentWorkspace, useWorkspacePaths } from "@didian/core/paths";
import { useWorkspaceId } from "@didian/core/hooks";
import { useIssueDraftStore } from "@didian/core/issues/stores/draft-store";
import { useCreateModeStore } from "@didian/core/issues/stores/create-mode-store";
import { useQuickCreateStore } from "@didian/core/issues/stores/quick-create-store";
import { issueDetailOptions, childIssuesOptions } from "@didian/core/issues/queries";
import { useCreateIssue, useUpdateIssue } from "@didian/core/issues/mutations";
import { useAttachLabelToIssue } from "@didian/core/labels";
...
import { Dialog as DialogRoot } from "@didian/ui/components/ui/dialog";
