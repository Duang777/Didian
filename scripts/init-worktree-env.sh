...
postgres_db="didian_${slug}_${offset}"
postgres_port=5432
...
DATABASE_URL=postgres://didian:didian@localhost:${postgres_port}/${postgres_db}?sslmode=disable

PORT=${backend_port}
JWT_SECRET=change-me-in-production
DIDIAN_DEV_VERIFICATION_CODE=888888
DIDIAN_SERVER_URL=ws://localhost:${backend_port}/ws
