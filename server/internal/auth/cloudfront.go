...
type CloudFrontSigner struct {
	...
	domain       string // CDN domain, e.g. "static.didian.ai"
	cookieDomain string // cookie scope, e.g. ".didian.ai"
}
...
//   - CLOUDFRONT_DOMAIN       (e.g. "static.didian.ai")
//   - COOKIE_DOMAIN           (e.g. ".didian.ai")
