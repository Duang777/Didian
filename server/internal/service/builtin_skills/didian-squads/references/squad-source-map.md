...
This file records source evidence for `didian-squads/SKILL.md`.
...
```text
server/cmd/didian/cmd_squad.go
```
...
```bash
didian squad list
didian squad get <squad-id>
didian squad create
didian squad update <squad-id>
didian squad delete <squad-id>
didian squad activity <issue-id> <outcome>

didian squad member list <squad-id>
didian squad member add <squad-id>
didian squad member remove <squad-id>
...
- agent member roster rows list assigned workspace skills via
  ...
  "no skills assigned"; builtin didian-* skills are excluded and human
