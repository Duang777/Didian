...
export const metadata: Metadata = {
  title: "Download Didian",
  description:
    "Download Didian for macOS, Windows, or Linux — or install the CLI for servers and remote dev boxes.",
  openGraph: {
    title: "Download Didian",
    description:
      "Get the Didian desktop app with a bundled daemon, or install the CLI for servers and remote dev boxes.",
    url: "/download",
  },
  alternates: {
    canonical: "/download",
