...
import type { AgentRuntime, RuntimeProfile } from "@didian/core/types";
...
vi.mock("@didian/core/runtimes/mutations", () => ({
...
describe("runtime list CLI column", () => {
  ...
  // shared didian daemon `cli_version`. It must instead show the agent's own
