...
vi.mock("@didian/core/github", async () => {
  const actual =
    await vi.importActual<typeof import("@didian/core/github")>("@didian/core/github");
  return {
    ...actual,
...
describe("GitHubTab", () => {
  ...
  it("clicking Disconnect opens the confirmation and only fires on confirm", async () => {
    ...
    expect(screen.getByText(/Didian will stop receiving webhooks/i)).toBeTruthy();
