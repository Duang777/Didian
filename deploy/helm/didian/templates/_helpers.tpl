...
*/}}
{{- define "didian.labels" -}}
app.kubernetes.io/name: didian
...
under the kustomize layout when installed as `helm install didian ...`.
*/}}
{{- define "didian.backend.fullname" -}}
{{ .Release.Name }}-backend
{{- end -}}

{{- define "didian.frontend.fullname" -}}
{{ .Release.Name }}-frontend
{{- end -}}

{{- define "didian.postgres.fullname" -}}
...
*/}}
{{- define "didian.databaseUrl" -}}
postgres://$(POSTGRES_USER):$(POSTGRES_PASSWORD)@{{ include "didian.postgres.fullname" . }}:5432/$(POSTGRES_DB)?sslmode=disable
{{- end -}}
