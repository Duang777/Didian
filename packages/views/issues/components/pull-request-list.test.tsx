...
import type { GitHubPullRequest } from "@didian/core/types";
import enCommon from "../../locales/en/common.json";
import enIssues from "../../locales/en/issues.json";

const TEST_RESOURCES = { en: { common: enCommon, issues: enIssues } };

vi.mock("@didian/core/github/queries", async () => {
  const actual = await vi.importActual<typeof import("@didian/core/github/queries")>(
    "@didian/core/github/queries",
  );
  return {
    ...actual,
