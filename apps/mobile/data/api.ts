 ...
 *
 * Types are imported via `import type` from @didian/core/types — zero
 * runtime coupling. Zod schemas + fallbacks are imported from
 * @didian/core/api/schemas (pure data, on the mobile sharing whitelist).
 *
 ...
 *  reasonable Didian payload size on cellular. */
