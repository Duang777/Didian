...
// ([MUL-2946](https://didian/issues/MUL-2946)). Subsequent PRs use
...
const (
	// Platform / scheduler side: failure attributable to Didian
	...
	// message. Treated as platform-side because it is a Didian-imposed
