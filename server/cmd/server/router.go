...
import (
	...
	composiointeg "github.com/didian-ai/didian/server/internal/integrations/composio"
	...
	composiosdk "github.com/didian-ai/didian/server/pkg/composio"
...
func NewRouterWithOptions(pool *pgxpool.Pool, hub *realtime.Hub, bus *events.Bus, analyticsClient analytics.Client, rdb *redis.Client, opts RouterOptions) (chi.Router, *handler.Handler) {
	...
	r.Route("/api/daemon", func(r chi.Router) {
		...
		r.Post("/runtimes/{runtimeId}/tasks/{taskId}/skills/report", h.ReportIssueSkillUsage)
		...
		r.Group(func(r chi.Router) {
			...
			r.Route("/api/issues", func(r chi.Router) {
				...
				r.Route("/{id}", func(r chi.Router) {
					...
					r.Get("/skills", h.ListIssueSkills)
					r.Post("/skills", h.AddIssueSkill)
					r.Delete("/skills/{skillId}", h.DeleteIssueSkill)
