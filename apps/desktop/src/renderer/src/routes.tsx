...
import { ProjectsPage } from "@didian/views/projects/components";
import { DashboardPage } from "@didian/views/dashboard";
import { AutopilotsPage } from "@didian/views/autopilots/components";
import { MyIssuesPage } from "@didian/views/my-issues";
import { SkillsPage } from "@didian/views/skills";
import { DesktopRuntimesPage } from "./components/desktop-runtimes-page";
import { DesktopAgentsPage } from "./components/desktop-agents-page";
import { SquadsPage, SquadDetailPage as SquadDetailPageView } from "@didian/views/squads/components";
