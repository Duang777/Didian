...
// loadTrustedProxies reads the same DIDIAN_TRUSTED_PROXIES env var the rest of
...
func loadTrustedProxies() []netip.Prefix {
	raw := strings.TrimSpace(os.Getenv("DIDIAN_TRUSTED_PROXIES"))
	if raw == "" {
		return nil
	}
...
// shared DIDIAN_TRUSTED_PROXIES value in here at startup.
