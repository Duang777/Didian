...
vi.mock("@didian/core/projects/mutations", () => ({
  useCreateProject: () => ({ mutateAsync: vi.fn() }),
}));

vi.mock("@didian/core/projects", () => ({
...
vi.mock("@didian/ui/components/ui/popover", () => ({
...
vi.mock("@didian/ui/components/common/emoji-picker", () => ({
  EmojiPicker: () => null,
}));
