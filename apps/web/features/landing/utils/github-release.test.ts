...
const SAMPLE_LATEST_ASSET = {
  name: "didian-desktop-0.2.14-mac-arm64.dmg",
  browser_download_url:
    "https://github.com/didian-ai/didian/releases/download/v0.2.14/didian-desktop-0.2.14-mac-arm64.dmg",
};

const SAMPLE_PREV_ASSET = {
  name: "didian-desktop-0.2.13-mac-arm64.dmg",
  browser_download_url:
    "https://github.com/didian-ai/didian/releases/download/v0.2.13/didian-desktop-0.2.13-mac-arm64.dmg",
};
...
function releasePayload(overrides: {
  ...
  return {
    ...
    html_url: `https://github.com/didian-ai/didian/releases/tag/${overrides.tag}`,
