-- Add a per-installation `region` so one Didian deployment can serve
...
-- deployment-wide value (the DIDIAN_LARK_HTTP_BASE_URL /
-- DIDIAN_LARK_CALLBACK_BASE_URL env knobs, defaulting to open.feishu.cn),
