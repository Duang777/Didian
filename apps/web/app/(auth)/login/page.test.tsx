...
import enCommon from "@didian/views/locales/en/common.json";
import enAuth from "@didian/views/locales/en/auth.json";
import enSettings from "@didian/views/locales/en/settings.json";
