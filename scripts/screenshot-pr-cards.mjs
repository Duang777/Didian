...
const DB = process.env.DATABASE_URL || "postgres://didian:didian@localhost:5432/didian_didian_101?sslmode=disable";
...
async function main() {
  ...
  await page.evaluate((t) => localStorage.setItem("didian_token", t), token);
