...
const SkillOpportunitySchema = z.object({
  ...
  pageType: z.enum(["technical_doc", "github_repo", "tutorial", "blog", "paper", "product_page", "unknown"]).default("unknown"),
  ...
  reusableWorkflowScore: z.number().default(0),
  instructionDensityScore: z.number().default(0),
  futureUseScore: z.number().default(0),
