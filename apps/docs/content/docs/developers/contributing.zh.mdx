---
title: Contributing
description: Local development workflow for contributors working on the Didian codebase.
---
...
| | Main | Worktree |
|---|---|---|
| Database | `didian` | `didian_my_feature_702` |
...
```bash
docker compose exec -T postgres psql -U didian -d postgres \
