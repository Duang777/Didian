...
RETURNING id, workspace_id, creator_id, source_type, source, capture_scope, source_tab_id, url, normalized_url, title, domain, favicon_url, description, preview_image_url, skill_opportunity, selected_text, readable_text, links, text_hash, page_hash, status, metadata_status, archive_status, summary_status, embedding_status, memory_state, failure_reason, captured_at, created_at, updated_at
`
...
SELECT id, workspace_id, creator_id, source_type, source, capture_scope, source_tab_id, url, normalized_url, title, domain, favicon_url, description, preview_image_url, skill_opportunity, selected_text, readable_text, links, text_hash, page_hash, status, metadata_status, archive_status, summary_status, embedding_status, memory_state, failure_reason, captured_at, created_at, updated_at FROM captured_source
...
SELECT captured_source.id, captured_source.workspace_id, captured_source.creator_id, captured_source.source_type, captured_source.source, captured_source.capture_scope, captured_source.source_tab_id, captured_source.url, captured_source.normalized_url, captured_source.title, captured_source.domain, captured_source.favicon_url, captured_source.description, captured_source.preview_image_url, captured_source.skill_opportunity, captured_source.selected_text, captured_source.readable_text, captured_source.links, captured_source.text_hash, captured_source.page_hash, captured_source.status, captured_source.metadata_status, captured_source.archive_status, captured_source.summary_status, captured_source.embedding_status, captured_source.memory_state, captured_source.failure_reason, captured_source.captured_at, captured_source.created_at, captured_source.updated_at FROM captured_source
