// Mirrors the didian-cloud Billing module response shapes
// (didian-cloud/docs/api/billing.md). These types are the contract our
// frontend consumes via /api/cloud-billing/* — didian-api itself does
