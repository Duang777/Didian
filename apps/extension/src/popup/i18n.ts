...
const zh: Table = {
  ...
  "capture.hint.page": "将捕获当前整页",
  "capture.hint.selection": "将捕获选中的内容",
  "history.title": "最近",
  "history.hide": "收起",
  "history.show": "展开",
  "history.empty": "还没有采集记录。",
  "history.openWorkbench": "在 Didian 中打开",
  "history.openSource": "打开原始网页",
  "settings.api": "API 地址",
...
const en: Table = {
  ...
  "capture.hint.page": "Will capture the whole page",
  "capture.hint.selection": "Will capture your selection",
  "history.title": "Recent",
  "history.hide": "Hide",
  "history.show": "Show",
  "history.empty": "No captures yet.",
  "history.openWorkbench": "Open in Didian",
