---
title: Architecture
description: Technical architecture of the Didian platform.
---

## Overview

Didian is a Go backend + monorepo frontend (pnpm workspaces + Turborepo) with shared packages.
...
- **Entry points** (`cmd/`): `server` (HTTP API), `didian` (CLI + daemon), `migrate`
