...
/**
 * Server-side fetcher for the latest Didian release, designed to
...
const GITHUB_RELEASES_URL =
  "https://api.github.com/repos/didian-ai/didian/releases?per_page=2";
...
export async function fetchLatestRelease(): Promise<LatestRelease> {
  ...
  try {
    ...
    // Defensive filter — Didian doesn't publish prereleases or drafts
