...
func TestEnsureCodexMcpConfigEmptyClearsBlock(t *testing.T) {
	...
	got := string(data)
	if strings.Contains(got, didianCodexMcpBeginMarker) {
...
func TestEnsureCodexMcpConfigWritesManagedBlock(t *testing.T) {
	...
	if !strings.Contains(got, didianCodexMcpBeginMarker) || !strings.Contains(got, didianCodexMcpEndMarker) {
