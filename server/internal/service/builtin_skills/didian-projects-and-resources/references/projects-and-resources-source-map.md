...
- `server/cmd/didian/cmd_project.go` registers project `list`, `get`, `create`, `update`, `delete`, and `status`.
...
- Project resources are written into `.didian/project/resources.json` for agent workdirs.
