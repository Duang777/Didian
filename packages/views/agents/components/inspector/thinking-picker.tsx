...
import type { RuntimeModelThinkingLevel } from "@didian/core/types";
import {
  PickerItem,
  PropertyPicker,
 ...
 * the user's local CLI install, not by Didian's catalog.
 */
      ...
      {levels.map((l) => (
        ...
        >
          ...
          {/* No model-factory-default badge here on purpose: when the
              picker is "Follow CLI config" (value === ""), Didian omits
