...
import type { Issue, IssueAssigneeType, IssueStatus, UpdateIssueRequest } from "@didian/core/types";
 ...
 * `@didian/core/issues/cache-helpers` so the board's optimistic placement on
