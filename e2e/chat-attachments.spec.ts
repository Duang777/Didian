 ...
 * The UI wiring is covered by `chat-input.test.tsx` in @didian/views; this
...
const DATABASE_URL =
  process.env.DATABASE_URL ?? "postgres://didian:didian@localhost:5432/didian?sslmode=disable";
