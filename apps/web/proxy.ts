...
import { LOCALE_COOKIE } from "@didian/core/i18n";
import {
  DIDIAN_LOCALE_HEADER,
...
// Forward the resolved locale to RSC layouts via the `x-didian-locale`
...
function nextWithLocale(req: NextRequest): NextResponse {
  ...
  headers.set(DIDIAN_LOCALE_HEADER, resolveLocale(req));
