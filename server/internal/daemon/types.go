...
// PersonalCapabilityTaskData is a Mission-selected personal capability
// delivered by the server for the claimed task.
...
type Task struct {
	...
	PersonalCapabilities     []PersonalCapabilityTaskData `json:"personal_capabilities,omitempty"` // Mission-selected capabilities for this run
