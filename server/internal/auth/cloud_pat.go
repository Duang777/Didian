...
// (Didian Cloud Node) PAT. Tokens with this prefix are validated by
// calling the Didian Cloud Fleet service rather than by hitting our
...
// DIDIAN_CLOUD_FLEET_URL configured simply rejects mcn_ tokens at
...
type CloudPATVerifierConfig struct {
	...
	// https://fleet.didian.cloud). Trailing slashes are trimmed.
