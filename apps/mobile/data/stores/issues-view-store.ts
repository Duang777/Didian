 ...
 * `@didian/core/issues/stores/issues-scope-store` — mobile only
 * `import type` from `@didian/core/types/*` per Sharing Principles, and
...
import type { IssuePriority, IssueStatus } from "@didian/core/types";
