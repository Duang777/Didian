...
var rootHelpTemplate = `Work seamlessly with Didian from the command line.

USAGE
  didian <command> <subcommand> [flags]
{{range .Groups}}
{{.Title}}
...
ENVIRONMENT VARIABLES
  DIDIAN_SERVER_URL    Override the default server URL
  DIDIAN_WORKSPACE_ID  Set the active workspace

LEARN MORE
  Use ` + "`didian <command> <subcommand> --help`" + ` for more information about a command.
`
