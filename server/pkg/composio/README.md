...
not import any other Didian package, so it can be reused by other services or
...
import (
    ...
    "github.com/didian-ai/didian/server/pkg/composio"
)
...
link, err := client.CreateLink(ctx, composio.CreateLinkRequest{
    ...
    UserID:       didianUserID.String(), // your own user id
    CallbackURL:  "https://app.didian.ai/api/integrations/composio/callback",
})
...
- **Standalone.** Zero coupling to Didian internals — depend on this package
