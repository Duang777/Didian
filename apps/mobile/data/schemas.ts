 ...
 * yet schematised in @didian/core/api/schemas. Lenient by design — see the
...
import { IssueSchema } from "@didian/core/api/schemas";
...
// availability derivation in @didian/core/agents/derive-presence. All other
...
export const EMPTY_ISSUE_FALLBACK: import("@didian/core/types").Issue = {
  id: "",
  workspace_id: "",
  number: 0,
  identifier: "",
