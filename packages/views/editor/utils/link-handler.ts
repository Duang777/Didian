...
import { isGlobalPath } from "@didian/core/paths";
...
/**
 * Open a link — internal paths dispatch didian:navigate, external open new tab.
 *
...
export function openLink(href: string, currentSlug?: string | null): void {
  if (href.startsWith("/")) {
    ...
    window.dispatchEvent(
      new CustomEvent("didian:navigate", { detail: { path } }),
    );
  } else {
